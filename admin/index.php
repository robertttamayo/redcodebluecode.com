...
//$bb->addHeadScript(array("src" => ASSETS_URL . "/js/min/jquery-1.11.1.min.js"));
//$bb->addHeadScript(array("src" => "https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"));
$bb->addHeadScript(array("src" => ASSETS_URL . "/js/core.js"));
...
$bb->addHeadScript(array("script" => 
                         ...
                         "var homeUrl = \"" . ADMIN_ROOT . "\";" .
                         "var dashboardTemplateDir = \"" . ADMIN_ROOT . SRC_DIR . "html/dashboard/\";" . 
                         "var mode = WELCOME;"));
